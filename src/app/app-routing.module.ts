        ...
        RouterModule.forRoot([
            {
                ...
                children: [
                { path: '', loadChildren: () => import('./orion/pages/dashboard/dashboard.module').then(m => m.DashboardModule) },
                    { path: 'uikit', loadChildren: () => import('./orion/components/uikit/uikit.module').then(m => m.UIkitModule) },
                    { path: 'utilities', loadChildren: () => import('./orion/components/utilities/utilities.module').then(m => m.UtilitiesModule) },
                    { path: 'documentation', loadChildren: () => import('./orion/components/documentation/documentation.module').then(m => m.DocumentationModule) },
                    { path: 'blocks', loadChildren: () => import('./orion/components/primeblocks/primeblocks.module').then(m => m.PrimeBlocksModule) },
