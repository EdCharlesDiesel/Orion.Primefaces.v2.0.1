...
@NgModule({
  imports: [RouterModule.forChild([
    ...
    {path: 'calendar', loadChildren: () => import('./calendar/calendar-routing.module').then(m => m.CalendarRoutingModule)},
    {path: 'reports', loadChildren: () => import('./blog/blog.module').then(m => m.BlogModule)},
